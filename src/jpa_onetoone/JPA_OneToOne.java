...
public class JPA_OneToOne {
    ...
    public static void main(String[] args) {
        ...
        Table1 t1 = new Table1(17, "Example T1 C1", "Example T1 C2");
        Table2 t2 = new Table2(17, "Example T2 C1", "Example T2 C2");
        //t1.setTable2(new Table2(17, "Example T2 C1", "Example T2 C2"));
